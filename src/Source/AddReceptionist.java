...
public class AddReceptionist extends JFrame implements ActionListener
{
    ...
    AddReceptionist()
    {
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Icons/ReceptionHome1.jpg"));
        Image i1 = img.getImage().getScaledInstance(900,600,Image.SCALE_SMOOTH);
        ImageIcon img1 = new ImageIcon(i1);
        l1.setIcon(img1);

        l2 = new JLabel("Add Receptionist's details");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==b1)
        {
            ...
            String rec_id = ""+Math.abs(random.nextInt()%100000);

            try
            {
                ConnectionClass obj = new ConnectionClass();
                String q ="INSERT INTO receptionists VALUES ('"+rec_id+"','"+name+"','"+father_name+"','"+username+"','"+password+"','"+email+"','"+phone+"','"+qualification+"','"+city+"','"+gender+"','"+blood+"','"+dob+"','"+age+"','"+address+"','"+joining_date+"')";
