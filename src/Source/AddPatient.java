...
public class AddPatient extends JFrame implements ActionListener
{
    ...
    AddPatient()
    {
        ...
        l2 = new JLabel("Add Patient's details");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==b1)
        {
            ...
            String pat_id = ""+Math.abs(random.nextInt()%100000);

            try
            {
                ConnectionClass obj = new ConnectionClass();
                String q ="INSERT INTO patients VALUES ('"+pat_id+"','"+name+"','"+father_name+"','"+username+"','"+password+"','"+email+"','"+phone+"','"+marital_status+"','"+city+"','"+gender+"','"+blood+"','"+dob+"','"+age+"','"+address+"','"+spec_needed+"')";
