...
public class AdminHomePage extends JFrame implements ActionListener
{
    ...
    AdminHomePage(String adminname,int login_Id,String p_username,String admin_Id)
    {
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("Icons/Admin2.jpg"));
        ...
        ment1 = new JMenuItem("Add Doctor");
        ...
        ment5 = new JMenuItem("Add Receptionist");
        ...
        men5 = new JMenu("Hi Admin("+adminname+")");
        m1.add(men5);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            new ChangePassword(adminname).setVisible(true);
        }
